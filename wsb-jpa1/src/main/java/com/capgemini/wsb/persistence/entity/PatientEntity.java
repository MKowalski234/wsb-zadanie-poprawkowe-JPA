...
public class PatientEntity {
	...
	// Relacja jeden-do-wielu z VisitEntity, z kaskadowaniem operacji zapisu i łączenia oraz leniwym ładowaniem
	@OneToMany(mappedBy = "patient", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
	private Collection<VisitEntity> visits;

	// Relacja wiele-do-wielu z AddressEntity, z kaskadowaniem operacji zapisu i łączenia oraz leniwym ładowaniem
